    ...
    ?>
      <tr>
       ...
       <td>
            ...
            <a href="?a=detail_pembahasan&id=<?php echo $data['id_paket']?>" class="btn btn-info btn-xs fa fa-folder-open" title="Buka soal dan pembahasan <?php echo $data['nama_paket'] ?>" data-toggle="tooltip"></a>
