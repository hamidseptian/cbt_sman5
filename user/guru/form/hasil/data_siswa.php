...
<div class="box-header with-border">
  <h3 class="box-title">Data Nilai Siswa Kelas  <?php echo $dkelas['nama_kelas'] ?></h3>
  <div class="pull-right">
    <a href="form/hasil/print_nilai_perkelas.php?id=<?php echo $idkelas ?>" class="btn btn-info btn-sm" target="_blank">Print</a>
  </div>
