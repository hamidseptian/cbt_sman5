<div class="box-header with-border">
  ...
  <div class="pull-right">
    <a href="form/ptk/print_ptk.php" class=" btn btn-info btn-sm" target="_blank">Print Data Guru</a>
    <a href="?a=tambah_ptk" class=" btn btn-info btn-sm" >Tambah Data</a>
  </div>
...
?>
	...
	<td>
    <a href="?a=edit_ptk&id=<?php echo $data['id_ptk'] ?>" class="btn btn-warning btn-xs">Edit</a> 
    <a href="form/ptk/hapus_ptk.php?id=<?php echo $data['id_ptk'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Hapus data ptk  atas nama <?php echo $data['nama_ptk'] ?>.?')">Hapus</a> 
	</td>
		</tr>
